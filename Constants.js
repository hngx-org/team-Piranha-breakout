...
export default Constants = {
  ...
  RACKET_Y_POSITION:
    Dimensions.get("screen").height - Dimensions.get("screen").height / 9,
  RACKET_START_X_POSITION: Dimensions.get("screen").width / 2,
  RACKET_MIN_X_POSITION:
    Dimensions.get("screen").width / 8 + Dimensions.get("screen").height / 52,
  RACKET_MAX_X_POSITION:
    Dimensions.get("screen").width -
    Dimensions.get("screen").width / 8 -
    Dimensions.get("screen").height / 52,
};
